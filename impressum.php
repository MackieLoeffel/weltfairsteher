...
<br>
        ...
        <div class="abstaende" style="padding: 20px; text-align: justify; background-color: #1BAB3F;">
          ...
          <span><a style="color: #1B4D0B;" class="indexlink" href="mailto:kontakt@weltfairsteher.jetzt" target="_top"><span data-title="kontakt@weltfairsteher.jetzt">kontakt@weltfairsteher.jetzt</span></a></span>
            ...
            <div class="abstaende" style=" text-align: justify; background-color: #1BAB3F; padding: 20px;">
              ...
              <span><a style="color: #1B4D0B;" class="indexlink" target="_blank" href="http://www.chancengestalten.de/"><span data-title="CHANGE – Chancen Nachhaltig Gestalten e.V.">CHANGE – Chancen Nachhaltig Gestalten e.V.</span></a></span><br>
  ...
  <div class="abstaende" style=" text-align: justify; background-color: #1BAB3F; padding: 20px;">
                  ...
                  <h4 style="color: white;">Rechtliche Hinweise</h4>
